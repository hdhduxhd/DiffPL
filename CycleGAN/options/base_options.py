...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--n_layers_N', type=int, default=4, help='only used if netN==n_layers.32*32(512)')
        ...
        parser.add_argument('--data-dir', default='/kaggle/input/fundus/Fundus', help='data root path')
        # additional parameters
        parser.add_argument('--epoch', type=str, default='latest', help='which epoch to load? set to latest to use latest cached model')
        parser.add_argument('--load_iter', type=int, default='200', help='which iteration to load? if load_iter > 0, the code will load models by iter_[load_iter]; otherwise, the code will load models by [epoch]')
