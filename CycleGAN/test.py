...
if __name__ == '__main__':
    ...
    for i, sample in enumerate(domain_loaderT):
        ...
        if dice_before_cup < dice_after_cup:
            print('image:{}, dice_before_cup{:.4f}<dice_after_cup{:.4f}'.format(i,dice_before_cup,dice_after_cup))
            count += 1
        if dice_before_disc < dice_after_disc:
            print('image:{}, dice_before_disc{:.4f}<dice_after_disc{:.4f}'.format(i,dice_before_disc,dice_after_disc))
            count += 1
